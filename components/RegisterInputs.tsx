...
const RegisterInputs = () => {
    return (
        <>
            ...
            <Input name='password' placeholder='Password' type='password' inputClass='w-full mb-[17px]' />
            <Input name='confirmPassword' placeholder='Confirm Password' type='password' inputClass='w-full mb-[41px]' />
        </>
    )
}
